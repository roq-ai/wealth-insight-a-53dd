...
import { getFinancialRecordById } from 'apiSdk/financial-records';
...
function FinancialRecordViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Financial Record Detail View
          </Text>
          {hasAccess('financial_record', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/financial-records/edit/${data?.id}`} passHref legacyBehavior>
              <Button
