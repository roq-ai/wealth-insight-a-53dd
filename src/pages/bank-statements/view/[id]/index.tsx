...
import { getBankStatementById } from 'apiSdk/bank-statements';
...
function BankStatementViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('bank_statement', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/bank-statements/edit/${data?.id}`} passHref legacyBehavior>
              <Button
